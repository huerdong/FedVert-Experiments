...
class AircraftDataset():
    ...
    def convert_features(self, file_path, device, feature_extractor=None, BS=32):
        ...
        for phase in ['train', 'test']:
            ...
            self.dataset[phase] = ExtractedFeatureDataset("aircraft", [], self.dataset_orig[phase])
    ...
    def load_features(self, file_path):
        with open(file_path, "rb") as pickle_f:
            ...
            self.dataset['train'] = ExtractedFeatureDataset("aircraft", load_pkl['train'], self.dataset_orig['train'])
            self.dataset['test'] = ExtractedFeatureDataset("aircraft", load_pkl['test'], self.dataset_orig['test'])

if __name__=="__main__":
    dset = AircraftDataset("./aircraft/fgvc-aircraft-2013b/data/images_new")
    #f_extractor = Res101()
    ...
    dset.convert_features("../out/aircraftresdensefeatures.pkl", device, f_extractor)
