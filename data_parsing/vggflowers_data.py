...
class VGGFlowersDataset():
    ...
    def convert_features(self, file_path, device, feature_extractor=None, BS=32):
        ...
        for phase in ['train', 'test']:
            ...
            self.dataset[phase] = ExtractedFeatureDataset("vggflowers", [], self.dataset_orig[phase])
    ...
    def load_features(self, file_path):
        with open(file_path, "rb") as pickle_f:
            ...
            self.dataset['train'] = ExtractedFeatureDataset("vggflowers", load_pkl['train'], self.dataset_orig['train'])
            self.dataset['test'] = ExtractedFeatureDataset("vggflowers", load_pkl['test'], self.dataset_orig['test'])

if __name__=="__main__":
    dset = VGGFlowersDataset("./vggflowers/images_new")
    #f_extractor = Res101()
    ...
    dset.convert_features("../out/vggflowersresdensefeatures.pkl", device, f_extractor)
