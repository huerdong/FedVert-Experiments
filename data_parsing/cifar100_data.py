...
class CIFAR100Dataset():
    def __init__(self, path):
        self.dataset_orig = {x: datasets.CIFAR100(path, train=(x=='train'), download=True, transform=transforms[x]) for x in phases}
    ...
    def convert_features(self, file_path, device, feature_extractor=None, BS=128):
        ...
        for phase in ['train', 'test']:
            ...
            self.dataset[phase] = ExtractedFeatureDataset("cifar100", [], self.dataset_orig[phase])
    ...
    def load_features(self, file_path):
        with open(file_path, "rb") as pickle_f:
            ...
            self.dataset['train'] = ExtractedFeatureDataset("cifar100", load_pkl['train'], self.dataset_orig['train'])
            self.dataset['test'] = ExtractedFeatureDataset("cifar100", load_pkl['test'], self.dataset_orig['test'])

if __name__=="__main__":
    dset = CIFAR100Dataset("./out/data/cifar100")
    ...
    dset.convert_features("./out/cifar100resdensefeatures.pkl", device, f_extractor)